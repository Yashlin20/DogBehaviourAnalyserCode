...
email_times = []
upperbound_time = timedelta(minutes = 30)
...
while (True):
    ...
    if ret :
        ...
        if(current_frame % 3 == 0):
            ...
            if (five_minute_interval_count == 6):
                five_minute_interval_count = 0
                ...
                if(unsettled_behaviour_five_minute_interval_count < 4):
                    first_email_flag = False
            ...
            if (first_email_flag == True and (
                    (total_time // 1000000 * 1000000) % timedelta(minutes = 5) == timedelta(seconds=0)) and (
